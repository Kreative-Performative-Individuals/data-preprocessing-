...
with open('C:\\Users\\mcapo\\Desktop\\Smart app project\\definitive\\definitivo_3\\transformation_interrupted.json', "w") as json_file:
    json.dump(data, json_file, indent=1) 

with open('C:\\Users\\mcapo\\data-preprocessing-\\data-preprocessing-\\store.json', "r") as json_file:
